...
const handleAssignPlan = async (targetUserId: string, selectedPlan: string) => {
  ...
  return (
    <div className="min-h-screen bg-[#070708] text-white flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 bg-gradient-to-tr from-red-700 to-red-600 rounded-lg flex items-center justify-center shadow-lg shadow-red-500/25">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 002 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
              </div>
            ...
            <div className="flex items-center gap-4">
              <span className="text-gray-300 font-bold text-sm">{user?.name}</span>
              <span className="bg-red-600/20 border border-red-500/30 text-red-400 px-3 py-1 rounded-full text-xs font-black tracking-wider uppercase">
                System Master
              </span>
      ...
      {/* Content wrapper */}
      <main className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 flex-grow w-full space-y-8">
